...
const Body = () => {
  return (
    ...
    <div className='flex items-center justify-center'>
      <img src="./src/assets/Blue-Shape.svg" alt="img1" className='h-64 -rotate-45 md:h-72'/>
      <img src="./src/assets/Pink-Shape.svg" alt="img2" className='absolute h-64 -rotate-[30deg]  md:h-72'/>
      <img src="./src/assets/Purple-shape.svg" alt="img3" className='absolute h-64 -rotate-[15deg]  md:h-72'/>
      <img src="./src/assets/Hero-Model.png" alt="hero" className='absolute h-64  md:h-72'/>
    </div>
